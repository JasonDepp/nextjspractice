...
/* harmony export */   "default": () => (/* binding */ MyTeam)
/* harmony export */ });
...
const username = js_cookie__WEBPACK_IMPORTED_MODULE_10__["default"].get('nextjsusername');
// Generate Order Data
...
function MyTeam() {
    ...
    async function getMySkillSetData() {
        var dataBody = {};
        const res = await fetch('/api/getteamskillsetdata', {
...
var __webpack_exports__ = __webpack_require__.X(0, [190,675,607], () => (__webpack_exec__(2538)));
